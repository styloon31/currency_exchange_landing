...
export default function FormTabs() {
  ...
  const exchangeRates = {
    USD: { buyRate: 86.6, sellRate: 87.05, symbol: "$" },
    EUR: { buyRate: 90.2, sellRate: 90.9, symbol: "€" },
    GBP: { buyRate: 107.6, sellRate: 108.55, symbol: "£" },
    AUD: { buyRate: 54.1, sellRate: 54.8, symbol: "A$" },
    CAD: { buyRate: 60.2, sellRate: 60.9, symbol: "C$" },
    NZD: { buyRate: 48.4, sellRate: 49.7, symbol: "$" },
    AED: { buyRate: 23.6, sellRate: 23.78, symbol: "د.إ" },
    SGD: { buyRate: 64.15, sellRate: 64.8, symbol: "S$" },
    THB: { buyRate: 2.59, sellRate: 2.622, symbol: "฿" },
    CHF: { buyRate: 95.6, sellRate: 96.9, symbol: "CHF" },
    JPY: { buyRate: 0.555, sellRate: 0.58, symbol: "¥" },
    HKD: { buyRate: 11.25, sellRate: 11.7, symbol: "HK$" },
    MYR: { buyRate: 19.75, sellRate: 20.6, symbol: "RM" },
