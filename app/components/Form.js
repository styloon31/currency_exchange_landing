...
export default function FormTabs() {
  ...
  const exchangeRates = {
    USD: { buyRate: 86.65, sellRate: 87.1, symbol: "$" },
    EUR: { buyRate: 90.2, sellRate: 90.9, symbol: "€" },
    GBP: { buyRate: 107.5, sellRate: 108.45, symbol: "£" },
    AUD: { buyRate: 54.2, sellRate: 54.9, symbol: "A$" },
    CAD: { buyRate: 60.1, sellRate: 60.8, symbol: "C$" },
    NZD: { buyRate: 48.4, sellRate: 49.7, symbol: "$" },
    AED: { buyRate: 23.62, sellRate: 23.8, symbol: "د.إ" },
    SGD: { buyRate: 64.15, sellRate: 64.8, symbol: "S$" },
    THB: { buyRate: 2.6, sellRate: 2.63, symbol: "฿" },
    CHF: { buyRate: 95.0, sellRate: 96.3, symbol: "CHF" },
    JPY: { buyRate: 0.557, sellRate: 0.582, symbol: "¥" },
    HKD: { buyRate: 11.25, sellRate: 11.7, symbol: "HK$" },
    MYR: { buyRate: 19.85, sellRate: 20.7, symbol: "RM" },
    SAR: { buyRate: 22.75, sellRate: 23.55, symbol: "﷼" },
    CNY: { buyRate: 12.2, sellRate: 12.5, symbol: "¥" },
