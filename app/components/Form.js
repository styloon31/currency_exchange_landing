...
export default function FormTabs() {
  ...
  const exchangeRates = {
    USD: { buyRate: 86.34, sellRate: 86.79, symbol: "$" },
    EUR: { buyRate: 90.19, sellRate: 90.89, symbol: "€" },
    GBP: { buyRate: 106.8, sellRate: 107.75, symbol: "£" },
    AUD: { buyRate: 54.56, sellRate: 55.26, symbol: "A$" },
    CAD: { buyRate: 60.32, sellRate: 61.02, symbol: "C$" },
    NZD: { buyRate: 48.77, sellRate: 50.07, symbol: "$" },
    AED: { buyRate: 23.54, sellRate: 23.72, symbol: "د.إ" },
    SGD: { buyRate: 64.05, sellRate: 64.7, symbol: "S$" },
    THB: { buyRate: 2.58, sellRate: 2.614, symbol: "฿" },
    CHF: { buyRate: 94.95, sellRate: 96.25, symbol: "CHF" },
    JPY: { buyRate: 0.55, sellRate: 0.575, symbol: "¥" },
    HKD: { buyRate: 11.18, sellRate: 11.63, symbol: "HK$" },
    MYR: { buyRate: 19.7, sellRate: 20.55, symbol: "RM" },
    SAR: { buyRate: 22.68, sellRate: 23.48, symbol: "﷼" },
    CNY: { buyRate: 12.12, sellRate: 12.42, symbol: "¥" },
    VND: { buyRate: 0.0035, sellRate: 0.00384, symbol: "₫" },
    IDR: { buyRate: 0.00535, sellRate: 0.00593, symbol: "Rp" },
  };
